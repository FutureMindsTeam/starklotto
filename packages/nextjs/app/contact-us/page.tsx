...
const ContactUsPage = () => {
  ...
  return (
    <div className="text-white text-center py-20 px-8 md:px-0">
      <h1 className="mt-6 md:mt-10 text-xl font-bold uppercase sm:text-[2rem] md:text-[4rem]">
        Contact Us
      </h1>
      <p className="m-4 md:m-8 text-[0.725rem] md:text-[1rem] uppercase text-[#CECDCD]">
      ...
      <div className="flex flex-col mt-8">
        <p className="text-sm uppercase font-semibold">
          Or ask in our telegram group
        </p>
        <Link
          className="[&>svg]:h-8 [&>svg]:w-8 self-center bg-white rounded-full"
          href="https://t.me/StarklottoContributors"
        >
          <svg
